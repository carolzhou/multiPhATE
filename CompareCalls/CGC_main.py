...
if DEBUG:
    print("CGC_main says, DEBUG:  sys.argv is", sys.argv)
if argCount > 1:
    ...
    if PHATE_PIPELINE:  # First parameter is "log=<logFile>", second is "gff=<gffFile>", and remaining parameters are genecall files to compare
        ...
        if argCount > 3:
            ...
            if match_log:
                ...
                if DEBUG:
                    print("CGC_main says, DEBUG: LOG has been opened")
            else:
                print("CGC_main says, ERROR: expects name of log file as first input parameter. Parameter was:", sys.argv[1])
            if match_gff:
...
if DEBUG:
    print("CGC_main says: Performing comparison....")
...
if CGC_PROGRESS == 'True':
    print("CGC_ain: Merging the gene call sets....")
if DEBUG:
...
if DEBUG:
    print("CGC_main says, DEBUG: printing report....")
    compareGCs.PrintAll()
...
if DEBUG:
    print("CGC: complete.")
GFF.close()
LOG.write("%s%s\n" % ("CGC_main: complete at ",datetime.datetime.now()))
LOG.close()
